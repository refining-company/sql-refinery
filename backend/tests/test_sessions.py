...
#
#     # Replay session with protocol-level patching
#     with patch_pipeline() as pipeline, utils.listen_server() as exchange:
#         src._recorder.replay_session(session_data, exchange)
#
